...
class ClassAttributeInspectorSpec extends AnyFlatSpec with should.Matchers:
  ...
  "ClassAttributeInspector.attributes" should "return a List of size 5 after evaluating MyTestClass" in {
  ...
  it should "return a List of size 6 after evaluating MyTestSubClass" in {
